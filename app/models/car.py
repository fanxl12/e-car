...
class Car(Base):
    ...
    brand = Column(String(18), nullable=False, comment='品牌')
    producer = Column(String(32), comment='制造商')
    company = Column(String(32), comment='生产企业')
    model = Column(String(18), nullable=False, comment='型号')
    ...
    source_url = Column(String(128), nullable=False, comment='来源网址')
    release_time = Column(String(32), comment='发布时间')
